...
// GNORIZONTAS OTI TO PROGRAMMA SPATALAEI TON PERISSOTERO XRONO STIS SYNARTHSEIS activateNN , trainNN PARALLHLOPOIHSA ME PARALLEL FOR KAI
// OTI ALLO CLAUSE XREIAZOTAN TA LOOPS AYTWN TWN SYNARTHSEVN
...
int main(){ 
    ...
    omp_set_num_threads(6); //meta apo dokimes proekipse oti to me 6 threads pairnw mikrotero xrono (me 8 kontinos xronos)
