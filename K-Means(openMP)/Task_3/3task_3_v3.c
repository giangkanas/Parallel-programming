...
void EstimateCenters(void){ //ME THN IDIA LOGIKH ME PRIN PARALLHLOPOIW KAI THN ESTIMATECENTERS XRHSIMOPOIWNTAS schedule ALLA TO APOTELESMA DEN EINAI KALYTERO 
							//APO THN VERSION 2
